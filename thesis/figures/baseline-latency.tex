...
\begin{axis}[
    ...
    \addplot [mark=square*,color=TUMGreen, thick,mark repeat*=15] table[col sep=comma,x=lat,y expr=1-\thisrow{cdf}] {figures/data/baseline-amdexp0-10mpps.csv};

    \addplot [mark=triangle*,color=TUMBlue, thick,mark repeat*=5] table[col sep=comma,x=lat,y expr=1-\thisrow{cdf}] {figures/data/baseline-omanyte-10mpps.csv};

    \addplot [mark=*,color=TUMPurple,mark repeat*=2] table[col sep=comma,x=lat,y expr=1-\thisrow{cdf}] {figures/data/baseline-narva-10mpps.csv};
