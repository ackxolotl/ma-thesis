...
\Cref{fig:pcie-topology} depicts a typical \ac{pcie} tree. On the \ac{cpu}
...
use descriptor rings have RX and TX descriptor rings. \Cref{fig:tx-ring} shows a
...
On Linux, virtual functions of SR-IOV-capable devices can be created by either
