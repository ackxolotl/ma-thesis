...
As de-facto standard, \ac{pcie} is used for communication with most
...
table consists of up to 65,536 entries with 256~bit each, i.e., up to \SI{2}{\mebi\byte}.
...
the \ac{pcie} bus. Although the function part of the BDF is only \SI{3}{\bit},
i.e., eight different functions, more VFs can be created by using different
device numbers for the virtual functions.
