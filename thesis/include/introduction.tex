...
environments could take over its host by abusing the device's memory access
privileges.
...
\acp{iommu} represent an interesting object of research. In this thesis, we want
to investigate performance and safety/security impacts of \acp{iommu} in
high-speed network environments, with a focus on Intel's and AMD's \acp{iommu}
on x86.
