...
\DeclareAcronym{mmu}{
    ...
    list                = {\Acl{mmu}.},
    extra               = {%
        Computer component that primarily translates virtual to physical memory
        addresses. Often part of the \ac{cpu}.
    }
}
...
\DeclareAcronym{nic}{
    ...
    list                = {\Acl{nic}.},
    extra               = {%
        Computer component that receives and transmits data via a computer
        network.
    }
}
\DeclareAcronym{os}{
