...
\DeclareAcronym{iommu}{
    ...
    list                = {\Acl{iommu}.},
    extra               = {%
        A \ac{mmu} between \acs{dma}-capable devices and main memory.
    }
}
\DeclareAcronym{tlb}{
    short               = {\sc{TLB}},
...
\DeclareAcronym{bios}{
    ...
    list                = {\Acl{bios}.},
    extra               = {%
        Firmware that initializes the hardware on boot before the \ac{os} is
        loaded.
    }
}
\DeclareAcronym{uefi}{
...
\DeclareAcronym{dmar}{
    ...
    list                = {\Acl{dmar}.},
    extra               = {%
        Part of \acp{iommu} that is responsible for address translation. Often
...
\DeclareAcronym{vf}{
    ...
    list                = {\Acl{vf}.},
    extra               = {%
        A lightweight \ac{pcie} function of a \ac{sriov}-capable device that can
...
\DeclareAcronym{pf}{
    ...
    list                = {\Acl{pf}.},
    extra               = {%
        A fully featured \ac{pcie} function that supports \ac{sriov} and creates
        and manages one or multiple \acp{vf} if required.
    }
}
